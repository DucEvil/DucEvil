...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">LUXURY STORE Store</a> - All rights reserved © 2024
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>VẬN CHUYỂN SIÊU TỐC
trong ngày nội thành HN</li>
                <li>Thanh toán linh hoạt: COD,Chuyển Khoản, Visa / master </li>
                <li>MIỄN PHÍ ĐỔI TRẢ
trong vòng 03 ngày sau khi nhận hàng</li>
                <li>Tư vấn - hỗ trợ
9:00 - 21:30 hằng ngày
                    <br>
                </li>
            </ul>
        </section>
